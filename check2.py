...
# 测试文本
test_text = "This is a sample text for analysis. I hope it works well."

# 处理文本
results = analysis_pipeline.process_text_pipeline(test_text, need_short=True, need_analyse=True)
